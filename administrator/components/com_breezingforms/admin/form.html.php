...
?>              <fieldset><legend><?php echo BFText::_('COM_BREEZINGFORMS_TAGS_AND_CONTENT'); ?></legend>
                <?php echo bf_alert('Joomla! tagging is supported in the full version only', 'https://crosstec.org/en/extensions/joomla-forms-download.html');?>
...
?>
			...
			<?php echo bf_alert('Salesforce® is supported in the full version only', 'https://crosstec.org/en/extensions/joomla-forms-download.html');?>
                     </fieldset>
<?php
                $tabs->endTab();
...
?>
			...
			<?php echo bf_alert('Dropbox® is supported in the full version only', 'https://crosstec.org/en/extensions/joomla-forms-download.html');?>
                </fieldset>
<?php
		$tabs->endTab();
...
?>
		<script type="text/javascript">
			...
			//-->
                ...
                <?php echo bf_alert('Get BreezingForms Full Version', 'http:s//crosstec.org/en/extensions/joomla-forms-download.html');?>
                <?php echo bf_alert('More features, no footers, no messages', 'https://crosstec.org/en/extensions/joomla-forms-download.html');?>
