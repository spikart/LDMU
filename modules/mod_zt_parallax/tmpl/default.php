...
elseif ($params->get('background_type', 'image') == 'image'){
    ...
    $document->addScript(JURI::base()."modules/mod_zt_parallax/assets/js/image.parallax.js");
    $document->addStylesheet(JURI::base()."modules/mod_zt_parallax/assets/css/style3.css");
    ...
    <div class="image-parallax-container" >
        <div class="image-parallax-container-bg">
            <div class="image-parallax-overlay" style=" opacity: <?php echo (1- $params->get('opacity', 0.1)); ?>; background-color: <?php echo $params->get('overlay_color_uploadV', '#000000') ?>;"></div>
            <div class="content">
                <?php echo $text_content; ?>
            </div>
            <img id="image<?php echo $module_id; ?>" class="image-parallax" src="<?php echo JURI::root() . $background_image; ?>" />
        </div>
    </div>
    <script>
        jQuery(document).ready(function(){
            var image = document.getElementById("image<?php echo $module_id; ?>");
            imageParallax(image);
            jQuery(window).scroll(function(){
                imageParallax(image);
            });
