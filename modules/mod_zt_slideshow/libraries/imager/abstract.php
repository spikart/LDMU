 ...
 */
if (!class_exists('ZtSlideshowImagerAbstract'))
{

    /**
     * Image process abstract class
     */
    abstract class ZtSlideshowImagerAbstract extends JObject
    {
        ...
        /**
         * Get ZtSlideshowImageSizer
         * We will use it calc new image size
         * @return \ZtSlideshowImagerSizer
         */
        public function getImageSizer()
        {
            $resizer = new ZtSlideshowImagerSizer($this->getWidth(), $this->getHeight());
            return $resizer;
        }
