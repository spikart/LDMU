 ...
 */
if (!class_exists('ZtSlideshowImagerGd'))
{
     ...
     */
    class ZtSlideshowImagerGd extends ZtSlideshowImagerAbstract
    {

        /**
         * Load image from physical file
         * @param string $imageFile
         * @return \ZtSlideshowImagerGd
         */
         ...
         * @param ZtSlideshowImageSizer $sizer
         * @return \ZtSlideshowImagerGd
         */
        ...
        public function addWatermark($imageFile, $options = array())
        {
            ...
            {
                $watermark = new ZtSlideshowImagerGd();
